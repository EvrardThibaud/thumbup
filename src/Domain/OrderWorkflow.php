...
final class OrderWorkflow
{
    ...
    public function requestRevision(Order $o): void { if (!$this->canRequestRevision($o)) throw new \LogicException('Invalid transition');$o->setStatus(OrderStatus::REVISION); $o->setUpdatedAt(new \DateTimeImmutable()); }
}
